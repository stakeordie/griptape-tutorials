...
exports.message = exports.multiMessage = exports.instantiateContract = exports.refContract = exports.extendContract = exports.createContract = exports.ContractTxResponseHandler = void 0;
...
function getContext(contractAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var address, key, height, padding, entropy;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    height = _a.sent();
                    padding = utils_1.getEntropyString(12);
                    entropy = utils_1.getEntropyString(12);
                    return [2, { address: address, key: key, height: height, padding: padding, entropy: entropy }];
            }
        });
    });
}
        ...
        get: function (contract, prop) {
            ...
            return new Proxy(contract[prop], {
                ...
                apply: function (func, thisArg, argumentsList) { return __awaiter(_this, void 0, void 0, function () {
                    var contractAddress, ctx, args, result, _a, handleMsg, memo, rawTransferAmount, fees, calculatedFee, transferAmount, response, e_1, errorHandler;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [2, bootstrap_1.queryContract(contractAddress, result)];
                            case 2:
                                if (!(func.type === MESSAGE_TYPE)) return [3, 6];
                            ...
                            case 3:
                                _b.trys.push([3, 5, , 6]);
                                return [4, bootstrap_1.executeContract(contractAddress, handleMsg, memo, transferAmount, calculatedFee)];
                            case 4:
                                response = _b.sent();
                            ...
                            case 5:
                                ...
                                return [3, 6];
                            case 6: return [2, Reflect.apply(func, thisArg, argumentsList)];
                        }
                    });
                }); },
            });
...
function extendContract(base, extended) {
    ...
    if (messageKeys.length > 0) {
        console.warn("You overrided the following values from Messages object:\n        " + messageKeys.toString());
    }
    if (queriesKey.length > 0) {
        console.warn("You overrided the following values from Queries object:\n        " + queriesKey.toString());
    }
    return result;
}
...
function multiMessage(infos, memo) {
    return __awaiter(this, void 0, void 0, function () {
        var messages, fees, _i, infos_1, info, contractAddress, ctx, message_1, transferAmount, entry, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    messages = [];
                ...
                case 2:
                    ctx = _a.sent();
                    message_1 = info.getMessage.apply(info, __spreadArray([ctx], info.args));
                    transferAmount = message_1.transferAmount
                        ? [message_1.transferAmount]
                        : [];
                    entry = {
                        contractAddress: contractAddress,
                        handleMsg: message_1.handleMsg,
                        transferAmount: transferAmount,
                    };
                    messages.push(entry);
                    fees += message_1.fees ? message_1.fees : 0;
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3, 1];
...
function message(contract, message) {
    var args = [];
