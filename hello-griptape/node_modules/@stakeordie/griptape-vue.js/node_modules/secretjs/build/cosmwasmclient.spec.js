    ...
    describe("queryContractRaw", () => {
        ...
        it("can query existing key", async () => {
            ...
            expect(JSON.parse(fromUtf8(raw))).toEqual({
                verifier: toBase64(encoding_1.Bech32.decode(contract.initMsg.verifier).data),
                beneficiary: toBase64(encoding_1.Bech32.decode(contract.initMsg.beneficiary).data),
                funder: toBase64(encoding_1.Bech32.decode(testutils_spec_1.faucet.address).data),
            });
        });
